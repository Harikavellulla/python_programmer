...
Label(root, text='Python', font='arial 15 bold').pack()
...
def Generator():
    ...
    #Ensuring at least one charecter from each type (Uppercase, Lowercase, Digits, Punctuation)
    if pass_len.get() >= 4:
         ...
         for _  in range(pass_len.get() - 4):
             password.append(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.punctuation))
